...
test('map',function(t){
	var map$$ = map;
	var arr1 = map$$([1,2,3],function(val, index) {
		return val + 1;
	});
	...
	var arr2 = map$$(obj,function(val,key){
